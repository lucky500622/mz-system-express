...
// 分页获取仓库信息
export const warehouseInfoModel = async (offset: number, limit: number, connection?: any) => {
...
// 分页获取仓库操作信息
export const warehouseActionInfoModel = async (offset: number, limit: number, connection?: any) => {
  const exec = (connection || pool) as typeof pool
