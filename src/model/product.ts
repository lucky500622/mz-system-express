...
// 分页获取商品信息
export const productInfoModel = async (offset: number, limit: number, connection?: any) => {
...
// 分页获取商品操作信息
export const productActionInfoModel = async (offset: number, limit: number, connection?: any) => {
  const exec = (connection || pool) as typeof pool
